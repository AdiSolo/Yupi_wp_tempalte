...
<script type="text/javascript">
    google_ad_client = "ca-pub-9984908628803867";
    google_ad_slot = "6543631837";
    google_ad_width = 728;
    google_ad_height = 90;
</script>
<!-- Publicitate 
...
<div id="post-<?php the_ID(); ?>" class="post <?php echo $class; ?>" >
	...
	<?php if($class == 'post-<div id="content">big') { ?>
		<div class="description">
...
?>
         <a href="https://yupi.md/arta/page/<?php echo $pageNumber+1;?>" class="index_more_posts">Mai multe articole >></a>
<?php } ?>
	  </div>
